		    ...
		    free(str_tmp2);
                ...
                */
                case JGEZ_CODE :  
                    val1 = RecebeEndereco();
                    str_tmp1 = NumPBinString(val1);
                    sprintf(str_msg,"%s%s000000",ZJMP,COND_GEZ);
                    parser_Write_Inst(str_msg,end_cnt);
                    end_cnt += 1;
                    sprintf(str_msg,"%s",str_tmp1);
                    parser_Write_Inst(str_msg,end_cnt);
                ...
                */
                case JLZ_CODE : 
                    val1 = RecebeEndereco();
                    str_tmp1 = NumPBinString(val1);
                    sprintf(str_msg,"%s%s000000",ZJMP,COND_LZ);
                    parser_Write_Inst(str_msg,end_cnt);
                    end_cnt += 1;
                    sprintf(str_msg,"%s",str_tmp1);
                    parser_Write_Inst(str_msg,end_cnt);
                ...
                */
                ...
                case JLEZ_CODE :
                    val1 = RecebeEndereco();
                    str_tmp1 = NumPBinString(val1);
                    sprintf(str_msg,"%s%s000000",ZJMP,COND_LEZ);
                    parser_Write_Inst(str_msg,end_cnt);
                    end_cnt += 1;
                    sprintf(str_msg,"%s",str_tmp1);
                    parser_Write_Inst(str_msg,end_cnt);
                ...
                */
                case CGZ_CODE : 
                    val1 = RecebeEndereco();
                    str_tmp1 = NumPBinString(val1);
                    sprintf(str_msg,"%s%s000000",ZCALL,COND_GZ);
                    parser_Write_Inst(str_msg,end_cnt);
                    end_cnt += 1;
                    sprintf(str_msg,"%s",str_tmp1);
                    parser_Write_Inst(str_msg,end_cnt);
                ...
                */
                case CGEZ_CODE : 
                    val1 = RecebeEndereco();
                    str_tmp1 = NumPBinString(val1);
                    sprintf(str_msg,"%s%s000000",ZCALL,COND_GEZ);
                    parser_Write_Inst(str_msg,end_cnt);
                    end_cnt += 1;
                    sprintf(str_msg,"%s",str_tmp1);
                    parser_Write_Inst(str_msg,end_cnt);
                ...
                */
                case CLZ_CODE :  
                    val1 = RecebeEndereco();
                    str_tmp1 = NumPBinString(val1);
                    sprintf(str_msg,"%s%s000000",ZCALL,COND_LZ);
                    parser_Write_Inst(str_msg,end_cnt);
                    end_cnt += 1;
                    sprintf(str_msg,"%s",str_tmp1);
                    parser_Write_Inst(str_msg,end_cnt);
                ...
                */
                case CLEZ_CODE :   
                    val1 = RecebeEndereco();
                    str_tmp1 = NumPBinString(val1);
                    sprintf(str_msg,"%s%s000000",ZCALL,COND_LEZ);
                    parser_Write_Inst(str_msg,end_cnt);
                    end_cnt += 1;
                    sprintf(str_msg,"%s",str_tmp1);
                    parser_Write_Inst(str_msg,end_cnt);
                ...
                */
                ...
                case CNN_CODE :
                    val1 = RecebeEndereco();
                    str_tmp1 = NumPBinString(val1);
                    sprintf(str_msg,"%s%s000000",CALL,COND_NN);
                    parser_Write_Inst(str_msg,end_cnt);
                    end_cnt += 1;
                    sprintf(str_msg,"%s",str_tmp1);
                    parser_Write_Inst(str_msg,end_cnt);
...
int BuscaInstrucao(char * nome)
{
    ...
    */
    ...
    // ! Novas instruções
    else if(strcmp(str_tmp,JNN_STR) == 0)
    {
        return JNN_CODE;
    } 
    else if(strcmp(str_tmp,CNN_STR) == 0)
    {
        return CNN_CODE;
    }
    else if(strcmp(str_tmp,JGZ_STR) == 0)
    {
        return JGZ_CODE;
    } 
    else if(strcmp(str_tmp,JGEZ_STR) == 0)
    {
        return JGEZ_CODE;
    }
    else if(strcmp(str_tmp,JLZ_STR) == 0)
    {
        return JLZ_CODE;
    }
    else if(strcmp(str_tmp,JLEZ_STR) == 0)
    {
        return JLEZ_CODE;
    }
    else if(strcmp(str_tmp,CGZ_STR) == 0)
    {
        return CGZ_CODE;
    } 
    else if(strcmp(str_tmp,CGEZ_STR) == 0)
    {
        return CGEZ_CODE;
    }
    else if(strcmp(str_tmp,CLZ_STR) == 0)
    {
        return CLZ_CODE;
    }
    else if(strcmp(str_tmp,CLEZ_STR) == 0)
    {
        return CLEZ_CODE;
    }
