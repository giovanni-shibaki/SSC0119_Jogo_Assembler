...
;	inc r1
;
;	(Para mudar a cor da letra você soma o valor da cor nesse caractere)
;
;	Exemplo: 
;	loadn r2, #256
;	add r4, r2, r4
...
;		jnz delay_voltar
;
;	mod r4, r5, r6 -> coloca em r4 o resultado do módulo r5 % r6
;
;
...
mensagem2 : string "........................................"
; Cada coluna da tela tem 40 posições
; Existem 30 linhas
; = 1200
; = 1200
